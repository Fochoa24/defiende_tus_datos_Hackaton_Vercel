# Registros públicos de sanciones y reclamos CMF

Fuente: https://www.cmfchile.cl/portal/principal/613/w3-propertyname-815.html

## Contenido

Información de Fiscalizados y otras instituciones registradas - CMF Chile - Comisión para el Mercado Financiero Chile (portal) /* Para el artículo institucional */
...
})(window,document,'script','dataLayer','GTM-MCSGVJGS'); window.dataLayer = window.dataLayer || [];
 function gtag(){dataLayer.push(arguments);}
 gtag('js', new Date());

 gtag('config', 'G-3JM671GRQ4'); .btn-evaluar-contenido {
 position: fixed;
 right: 15px;
 animation-name: expandirBtn;
 animation-duration: 1s;
...
@media (max-width: 767.98px) {
 ...
 display: block;
} /*Escala de tipografia, minor 3rd 400px a major 3rd 1440px*/
:root {
...
#secciones_2024 .ntg-card .bi-arrow-up-short {
...
} #recuadros_actualidad {
 display: contents !important;
} <!--
 $(function(){
 var urls = [{ "id":"hechos","url":"https://www.cmfchile.cl/institucional/hechos/hechos_portada.php"},
 { "id":"sanciones","url":"https://www.cmfchile.cl/institucional/sanciones/sanciones_cursadas_mes.php"},
 { "id":"resoluciones","url":"https://www.cmfchile.cl/institucional/resoluciones/resoluciones_cursadas.php"},
 { "id":"actas","url":"https://www.cmfchile.cl/institucional/mercados/reporte_sajac/index.php?pagina=paginas.rep_actas_acc&junta=O&periodo=180"},
 { "id":"comunicaciones","url":"https://www.cmfchile.cl/institucional/mercados/comunicaciones_detalle2.php?entidad=RVEMI"},
 { "id":"opas","url":"https://www.cmfchile.cl/institucional/mercados/opas_detalle2.php"},
 { "id":"tdc","url":"https://www.cmfchile.cl/institucional/mercados/tomas_detalle.php"}
 ...
 cargaInforme(urls);
 cargaNormativa("https://www.cmfchile.cl/institucional/legislacion_normativa/normativa_portada.php");
});
function cargaInforme(lista){
 ...
 window.console && console.log( msg + XMLHttpRequest.status + " " + XMLHttpRequest.statusText );
 return;
 }
 ...
 if (curr.id == "actas"){
 codigo = codigo.replace(/\.\.\/entidad.php/ig,'/institucional/mercados/entidad.php');
 }
 $("#"+ curr.id).html(codigo);
 $("tr:gt(100)",this).remove();
 }
...
$.getJSON(url, function( data,textStatus, XMLHttpRequest ) {
 ...
 if ( textStatus == "error" ) {
 var msg = "Sorry but there was an error: ";
 windows.console && console.log( msg + XMLHttpRequest.status + " " + XMLHttpRequest.statusText );
 return;
 }
...
Buscar 
- Podcast "Cuidando Mis Finanzas" Instagram Facebook Youtube Linkedin WhatsApp X English overview 
- La CMF 
Presentación 
Qué es la CMF Consejo y Autoridades Trabaja en CMF Inclusión Financiera Marco regulatorio Organigrama Relaciones internacionales Transparencia de la Comisión Unidad de Investigación 
- Atención Fiscalizados 
CMF Supervisa SEIL Extranet Bancos CMF sin papel 

- Inicio 
- Atención Ciudadana, Trámites, Consultas y Reclamos 
- Información de Fiscalizados y otras instituciones registradas 
- Legislación y Normativa 
- Educación Financiera 
- Publicaciones, Estadísticas y Datos 
...
Información de Fiscalizados y otras instituciones registradas 
Menú . 
Entidades fiscalizadas y otras instituciones Reportes Información general Registros 

Búsqueda de fiscalizados 
Buscar el fiscalizado Buscar Ingrese nombre o parte del nombre, o RUT sin puntos ni guiones // Para limpiar texto buscar por default
 ...
 if (elemento.value == ""){
 elemento.value = "Ingrese nombre o RUT";
 return false;
 }
 else {
 return true;
...
Entidades fiscalizadas y otras instituciones 
...
Portales CMF y accesos especiales 
- Atención en línea 
- CMF
 sin papel 
- CMF Educa 
...
- Garantía
 Estatal y
 Preferencias para los Depósitos y Captaciones 
- Mapa
 del sitio 
...
Call center institucional: (56 2) 2617 4000 - (56 2) 2887 9200 
RUT: 60.810.000-8 
Contáctenos 
Suscripción a información relevante de
 la
 CMF 

- Síganos en: 
- Podcast "Cuidando Mis
 Finanzas" Instagram Facebook Youtube Linkedin WhatsApp X 
Subir //<![CDATA[
...
Encuesta Sitio Web Institucional × 
...
$(".ntg-required input, .ntg-required textarea", frm).each(function(){
 ...
 _field = frm.Explicacion;if((_field&&_field.validity&&!_field.checkValidity())){$(_field).focus();$('#Explicacion_div_530').addClass('ntg-invalid');$('#Explicacion_div_530 span.ntg-warning').remove();$('#Explicacion_div_530 label:first').after('<span class="ntg-warning alert alert-warning"><\/span>');$('#Explicacion_div_530 span.ntg-warning').text('Debe especificar [*] La respuesta es obligatoria. Debe escoger una opción.');_is_valid = false;}else{$('#Explicacion_div_530 span.ntg-warning').remove();$('#Explicacion_div_530').removeClass('ntg-invalid');}
...
¿Cuál es la probabilidad de que visite el sitio Web de la CMF nuevamente? [*] 
...
- 10 
¿Navegar dentro del sitio web resulta una experiencia fácil? [*] 
...
- 10 
¿Qué probabilidad hay que recomiende el sitio Web de la CMF? [*] 
...
- 10 
[*] La respuesta es obligatoria. Debe escoger una opción. 
<!--
...
--> <!--
 ...
 --> 
+a Agrandar texto -a Agrandar texto <!--
